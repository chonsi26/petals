...
<section class="section" id="shop">
  ...
  <div class="flower-grid" id="flowerGrid">
    ...
    ?>
    <div class="flower-card" data-cat="<?= htmlspecialchars($f['category'] ?? '') ?>" onclick='openOrderModal(<?= json_encode([
      'id'        => $f['id'],
      'name'      => $f['name'],
      'category'  => $f['category'],
      'price'     => $f['price'],
      ...
      <div class="fc-body">
        ...
        <div class="fc-footer">
          ...
          <button class="btn btn-primary btn-xs" <?= $inStock <= 0 ? 'disabled style="opacity:.5;cursor:not-allowed"' : '' ?>>
...
<section class="section section-sm">
  <div class="section-head">
    ...
    <p>Real reviews from real people who chose Petals for their special moments.</p>
  </div>
  <div class="testi-grid">
    <div class="testi-card">
      <div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
      <span class="testi-quote">"</span>
      <p class="testi-text">Ordered roses for our anniversary and they arrived in perfect condition. The packaging was so elegant. My wife absolutely loved it.</p>
      <div class="testi-author">
        <div class="testi-avatar">SR</div>
        <div>
          <div class="testi-name">Sofia R.</div>
          <div class="testi-loc">Cebu City</div>
        </div>
      </div>
    </div>
    <div class="testi-card">
      <div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
      <span class="testi-quote">"</span>
      <p class="testi-text">The lavender bouquet was stunning. Delivery was on time and the flowers stayed fresh for over a week. Highly recommend Petals.</p>
      <div class="testi-author">
        <div class="testi-avatar">BC</div>
        <div>
          <div class="testi-name">Bianca C.</div>
          <div class="testi-loc">Manila</div>
        </div>
      </div>
    </div>
    <div class="testi-card">
      <div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
      <span class="testi-quote">"</span>
      <p class="testi-text">I send flowers to my mom every month and Petals never disappoints. The quality is consistent and the service is always friendly.</p>
      <div class="testi-author">
        <div class="testi-avatar">IS</div>
        <div>
          <div class="testi-name">Isabelle S.</div>
          <div class="testi-loc">Davao City</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="delivery-banner">
  <h2>Free Delivery This Weekend</h2>
  <p>Order any bouquet of 3 stems or more this Saturday or Sunday and enjoy complimentary delivery anywhere in Metro Cebu.</p>
  <div style="display:flex; gap:.85rem; justify-content:center; flex-wrap:wrap;">
    <a href="#order" class="btn btn-white">Order Now</a>
    <a href="#shop" class="btn btn-white-outline">View Collection</a>
  </div>
</div>
